 ...
 *   @Description: 部门服务
 */
@FeignClient(contextId = "remoteAreaService", value = ServiceNameConstants.SYSTEM_SERVICE)
public interface RemoteAreaService {

    /**
     * 获取部门列表
     */
    @GetMapping(value = "/area/listAreas")
    ...
    ResultBean<WorkFlowAreaDTO> queryGroupByKey(@RequestParam(value = "groupKey", required = true) String groupKey);
}
