...
import com.workflow.process.bussiness.utils.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * @Exception
     */
    public static String stringRemove(String sourceString, String[] strings) {
        if (ArrayUtils.isNotEmpty(strings)) {
            for (String s : strings) {
                sourceString = org.apache.commons.lang3.StringUtils.remove(sourceString, s);
            }
        }
        return sourceString;
    }
